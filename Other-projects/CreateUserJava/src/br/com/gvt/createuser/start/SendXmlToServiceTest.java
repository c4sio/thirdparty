 ...
 * 
 */
public class SendXmlToServiceTest {

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		SendXmlToServiceTest sendXmlToService = new SendXmlToServiceTest();
		...
		try {
			...
			xmlString.append("<S:Envelope xmlns:S=\"http://schemas.xmlsoap.org/soap/envelope/\">");
				xmlString.append("<S:Header>");
					...
					xmlString.append("<To xmlns=\"http://www.w3.org/2005/08/addressing\">https://GALexterior.localdomain/GAL/OProv_Management</To>");
